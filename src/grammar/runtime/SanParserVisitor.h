...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitPointerExpression(SanParser::PointerExpressionContext *context) = 0;
    ...
    virtual antlrcpp::Any visitClassBodyElement(SanParser::ClassBodyElementContext *context) = 0;
