...
SandParser::InstructionsContext* SandParser::instructions() {
  ...
  try {
    ...
    while ((((_la & ~ 0x3fULL) == 0) &&
      ...
      | (1ULL << SandParser::Alias))) != 0) || ((((_la - 64) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 64)) & ((1ULL << (SandParser::Attribute - 64))
      | (1ULL << (SandParser::Assembly - 64))
      | (1ULL << (SandParser::Import - 64))
      | (1ULL << (SandParser::True - 64))
      | (1ULL << (SandParser::False - 64))
      | (1ULL << (SandParser::NullLiteral - 64))
      | (1ULL << (SandParser::VariableName - 64))
      | (1ULL << (SandParser::StringLiteral - 64))
      | (1ULL << (SandParser::CharLiteral - 64))
      | (1ULL << (SandParser::DecimalLiteral - 64))
      | (1ULL << (SandParser::FloatingLiteral - 64))
      | (1ULL << (SandParser::ZeroLiteral - 64))
      | (1ULL << (SandParser::HexadecimalLiteral - 64))
      | (1ULL << (SandParser::BinaryLiteral - 64)))) != 0)) {
      setState(152);
      statement();
      setState(157);
      _errHandler->sync(this);
      ...
      if (alt == 1) {
        ...
        case 9: {
          ...
          if ((((_la & ~ 0x3fULL) == 0) &&
            ...
            | (1ULL << SandParser::SizeOf)
            | (1ULL << SandParser::Function)
            | (1ULL << SandParser::Extern))) != 0) || ((((_la - 64) & ~ 0x3fULL) == 0) &&
            ((1ULL << (_la - 64)) & ((1ULL << (SandParser::Attribute - 64))
            | (1ULL << (SandParser::True - 64))
            | (1ULL << (SandParser::False - 64))
            | (1ULL << (SandParser::NullLiteral - 64))
...
SandParser::IntegerLiteralContext* SandParser::integerLiteral() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if (!(((((_la - 74) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 74)) & ((1ULL << (SandParser::DecimalLiteral - 74))
      | (1ULL << (SandParser::ZeroLiteral - 74))
      | (1ULL << (SandParser::HexadecimalLiteral - 74))
      | (1ULL << (SandParser::BinaryLiteral - 74)))) != 0))) {
    _errHandler->recoverInline(this);
    }
    else {
      _errHandler->reportMatch(this);
...
SandParser::ClassBodyContext* SandParser::classBody() {
  ...
  try {
    ...
    while (((((_la - 39) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 39)) & ((1ULL << (SandParser::Class - 39))
      | (1ULL << (SandParser::Static - 39))
      | (1ULL << (SandParser::Union - 39))
      | (1ULL << (SandParser::Function - 39))
      | (1ULL << (SandParser::Extern - 39))
      | (1ULL << (SandParser::Alias - 39))
      | (1ULL << (SandParser::Attribute - 39))
      | (1ULL << (SandParser::VariableName - 39)))) != 0)) {
      setState(624);
      classBodyElement();
      setState(629);
      _errHandler->sync(this);
