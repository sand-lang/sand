...
tree::TerminalNode* SanParser::BitwiseNegationExpressionContext::Neg() {
  return getToken(SanParser::Neg, 0);
}

SanParser::ExpressionContext* SanParser::BitwiseNegationExpressionContext::expression() {
  return getRuleContext<SanParser::ExpressionContext>(0);
}

SanParser::BitwiseNegationExpressionContext::BitwiseNegationExpressionContext(ExpressionContext *ctx) { copyFrom(ctx); }


antlrcpp::Any SanParser::BitwiseNegationExpressionContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<SanParserVisitor*>(visitor))
...
tree::TerminalNode* SanParser::OverloadableOperatorContext::Neg() {
  return getToken(SanParser::Neg, 0);
}
